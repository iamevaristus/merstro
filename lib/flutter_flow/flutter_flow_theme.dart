...
class LightModeTheme extends FlutterFlowTheme {
  Color primaryColor = const Color(0xFF07034D);
  Color secondaryColor = const Color(0xFF07034D);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  Color tertiaryColor = const Color(0xFFFEFEFE);
  Color alternate = const Color(0xFFFFFFFF);
  Color primaryBackground = const Color(0x00000000);
  Color secondaryBackground = const Color(0xFF00021E);
